...
const (
	WEBHOOKEVENT_REPOREFS_CHANGED        WebhookEvent = "repo:refs_changed"
	WEBHOOKEVENT_REPOCOMMENTADDED        WebhookEvent = "repo:comment:added"
	WEBHOOKEVENT_REPOMODIFIED            WebhookEvent = "repo:modified"
	WEBHOOKEVENT_REPOFORKED              WebhookEvent = "repo:forked"
	WEBHOOKEVENT_REPOCOMMENTEDITED       WebhookEvent = "repo:comment:edited"
	WEBHOOKEVENT_REPOCOMMENTDELETED      WebhookEvent = "repo:comment:deleted"
	WEBHOOKEVENT_MIRRORREPO_SYNCHRONIZED WebhookEvent = "mirror:repo_synchronized"
	WEBHOOKEVENT_PROPENED                WebhookEvent = "pr:opened"
	WEBHOOKEVENT_PRFROM_REF_UPDATED      WebhookEvent = "pr:from_ref_updated"
	WEBHOOKEVENT_PRMODIFIED              WebhookEvent = "pr:modified"
	WEBHOOKEVENT_PRREVIEWERUPDATED       WebhookEvent = "pr:reviewer:updated"
	WEBHOOKEVENT_PRREVIEWERAPPROVED      WebhookEvent = "pr:reviewer:approved"
	WEBHOOKEVENT_PRREVIEWERUNAPPROVED    WebhookEvent = "pr:reviewer:unapproved"
	WEBHOOKEVENT_PRREVIEWERNEEDS_WORK    WebhookEvent = "pr:reviewer:needs_work"
	WEBHOOKEVENT_PRMERGED                WebhookEvent = "pr:merged"
	WEBHOOKEVENT_PRDECLINED              WebhookEvent = "pr:declined"
	WEBHOOKEVENT_PRDELETED               WebhookEvent = "pr:deleted"
	WEBHOOKEVENT_PRCOMMENTADDED          WebhookEvent = "pr:comment:added"
	WEBHOOKEVENT_PRCOMMENTEDITED         WebhookEvent = "pr:comment:edited"
	WEBHOOKEVENT_PRCOMMENTDELETED        WebhookEvent = "pr:comment:deleted"
)
