...
type ChildrenAllOf struct {
	Values *[]ChildrenAllOfValues `json:"values,omitempty"`
}
...
// SetValues gets a reference to the given []ChildrenAllOfValues and assigns it to the Values field.
func (o *ChildrenAllOf) SetValues(v []ChildrenAllOfValues) {
	o.Values = &v
}

func (o ChildrenAllOf) MarshalJSON() ([]byte, error) {
...
type NullableChildrenAllOf struct {
	value *ChildrenAllOf
	isSet bool
}

func (v NullableChildrenAllOf) Get() *ChildrenAllOf {
	return v.value
}

func (v *NullableChildrenAllOf) Set(val *ChildrenAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableChildrenAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableChildrenAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChildrenAllOf(val *ChildrenAllOf) *NullableChildrenAllOf {
	return &NullableChildrenAllOf{value: val, isSet: true}
}

func (v NullableChildrenAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChildrenAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
