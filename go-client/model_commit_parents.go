...
func (o CommitParents) MarshalJSON() ([]byte, error) {
...
type NullableCommitParents struct {
	value *CommitParents
	isSet bool
}

func (v NullableCommitParents) Get() *CommitParents {
	return v.value
}

func (v *NullableCommitParents) Set(val *CommitParents) {
	v.value = val
	v.isSet = true
}

func (v NullableCommitParents) IsSet() bool {
	return v.isSet
}

func (v *NullableCommitParents) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommitParents(val *CommitParents) *NullableCommitParents {
	return &NullableCommitParents{value: val, isSet: true}
}

func (v NullableCommitParents) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommitParents) UnmarshalJSON(src []byte) error {
	v.isSet = true
