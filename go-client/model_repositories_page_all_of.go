...
type RepositoriesPageAllOf struct {
...
func (o RepositoriesPageAllOf) MarshalJSON() ([]byte, error) {
...
type NullableRepositoriesPageAllOf struct {
	value *RepositoriesPageAllOf
	isSet bool
}

func (v NullableRepositoriesPageAllOf) Get() *RepositoriesPageAllOf {
	return v.value
}

func (v *NullableRepositoriesPageAllOf) Set(val *RepositoriesPageAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableRepositoriesPageAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableRepositoriesPageAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRepositoriesPageAllOf(val *RepositoriesPageAllOf) *NullableRepositoriesPageAllOf {
	return &NullableRepositoriesPageAllOf{value: val, isSet: true}
}

func (v NullableRepositoriesPageAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRepositoriesPageAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
