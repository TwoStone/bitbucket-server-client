...
func (o WebhooksPage) MarshalJSON() ([]byte, error) {
...
type NullableWebhooksPage struct {
	value *WebhooksPage
	isSet bool
}

func (v NullableWebhooksPage) Get() *WebhooksPage {
	return v.value
}

func (v *NullableWebhooksPage) Set(val *WebhooksPage) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhooksPage) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhooksPage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhooksPage(val *WebhooksPage) *NullableWebhooksPage {
	return &NullableWebhooksPage{value: val, isSet: true}
}

func (v NullableWebhooksPage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhooksPage) UnmarshalJSON(src []byte) error {
	v.isSet = true
