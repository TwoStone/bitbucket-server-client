...
type BuildStatusPageAllOf struct {
...
func (o BuildStatusPageAllOf) MarshalJSON() ([]byte, error) {
...
type NullableBuildStatusPageAllOf struct {
	value *BuildStatusPageAllOf
	isSet bool
}

func (v NullableBuildStatusPageAllOf) Get() *BuildStatusPageAllOf {
	return v.value
}

func (v *NullableBuildStatusPageAllOf) Set(val *BuildStatusPageAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableBuildStatusPageAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableBuildStatusPageAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBuildStatusPageAllOf(val *BuildStatusPageAllOf) *NullableBuildStatusPageAllOf {
	return &NullableBuildStatusPageAllOf{value: val, isSet: true}
}

func (v NullableBuildStatusPageAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBuildStatusPageAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
