...
func (o PullRequestDelete) MarshalJSON() ([]byte, error) {
...
type NullablePullRequestDelete struct {
	value *PullRequestDelete
	isSet bool
}

func (v NullablePullRequestDelete) Get() *PullRequestDelete {
	return v.value
}

func (v *NullablePullRequestDelete) Set(val *PullRequestDelete) {
	v.value = val
	v.isSet = true
}

func (v NullablePullRequestDelete) IsSet() bool {
	return v.isSet
}

func (v *NullablePullRequestDelete) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePullRequestDelete(val *PullRequestDelete) *NullablePullRequestDelete {
	return &NullablePullRequestDelete{value: val, isSet: true}
}

func (v NullablePullRequestDelete) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePullRequestDelete) UnmarshalJSON(src []byte) error {
	v.isSet = true
