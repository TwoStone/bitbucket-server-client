...
func NewRepositoryRefRepositoryProject(key string) *RepositoryRefRepositoryProject {
	this := RepositoryRefRepositoryProject{}
	this.Key = key
	return &this
}
...
func (o RepositoryRefRepositoryProject) MarshalJSON() ([]byte, error) {
...
type NullableRepositoryRefRepositoryProject struct {
	value *RepositoryRefRepositoryProject
	isSet bool
}

func (v NullableRepositoryRefRepositoryProject) Get() *RepositoryRefRepositoryProject {
	return v.value
}

func (v *NullableRepositoryRefRepositoryProject) Set(val *RepositoryRefRepositoryProject) {
	v.value = val
	v.isSet = true
}

func (v NullableRepositoryRefRepositoryProject) IsSet() bool {
	return v.isSet
}

func (v *NullableRepositoryRefRepositoryProject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRepositoryRefRepositoryProject(val *RepositoryRefRepositoryProject) *NullableRepositoryRefRepositoryProject {
	return &NullableRepositoryRefRepositoryProject{value: val, isSet: true}
}

func (v NullableRepositoryRefRepositoryProject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRepositoryRefRepositoryProject) UnmarshalJSON(src []byte) error {
	v.isSet = true
