...
func (o CreateRepository) MarshalJSON() ([]byte, error) {
...
type NullableCreateRepository struct {
	value *CreateRepository
	isSet bool
}

func (v NullableCreateRepository) Get() *CreateRepository {
	return v.value
}

func (v *NullableCreateRepository) Set(val *CreateRepository) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateRepository) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateRepository) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateRepository(val *CreateRepository) *NullableCreateRepository {
	return &NullableCreateRepository{value: val, isSet: true}
}

func (v NullableCreateRepository) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateRepository) UnmarshalJSON(src []byte) error {
	v.isSet = true
