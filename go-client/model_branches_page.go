...
func (o BranchesPage) MarshalJSON() ([]byte, error) {
...
type NullableBranchesPage struct {
	value *BranchesPage
	isSet bool
}

func (v NullableBranchesPage) Get() *BranchesPage {
	return v.value
}

func (v *NullableBranchesPage) Set(val *BranchesPage) {
	v.value = val
	v.isSet = true
}

func (v NullableBranchesPage) IsSet() bool {
	return v.isSet
}

func (v *NullableBranchesPage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBranchesPage(val *BranchesPage) *NullableBranchesPage {
	return &NullableBranchesPage{value: val, isSet: true}
}

func (v NullableBranchesPage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBranchesPage) UnmarshalJSON(src []byte) error {
	v.isSet = true
