...
func (o CommitsPage) MarshalJSON() ([]byte, error) {
...
type NullableCommitsPage struct {
	value *CommitsPage
	isSet bool
}

func (v NullableCommitsPage) Get() *CommitsPage {
	return v.value
}

func (v *NullableCommitsPage) Set(val *CommitsPage) {
	v.value = val
	v.isSet = true
}

func (v NullableCommitsPage) IsSet() bool {
	return v.isSet
}

func (v *NullableCommitsPage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommitsPage(val *CommitsPage) *NullableCommitsPage {
	return &NullableCommitsPage{value: val, isSet: true}
}

func (v NullableCommitsPage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommitsPage) UnmarshalJSON(src []byte) error {
	v.isSet = true
