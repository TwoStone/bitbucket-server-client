...
type PullRequestsPageAllOf struct {
...
func (o PullRequestsPageAllOf) MarshalJSON() ([]byte, error) {
...
type NullablePullRequestsPageAllOf struct {
	value *PullRequestsPageAllOf
	isSet bool
}

func (v NullablePullRequestsPageAllOf) Get() *PullRequestsPageAllOf {
	return v.value
}

func (v *NullablePullRequestsPageAllOf) Set(val *PullRequestsPageAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullablePullRequestsPageAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullablePullRequestsPageAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePullRequestsPageAllOf(val *PullRequestsPageAllOf) *NullablePullRequestsPageAllOf {
	return &NullablePullRequestsPageAllOf{value: val, isSet: true}
}

func (v NullablePullRequestsPageAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePullRequestsPageAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
