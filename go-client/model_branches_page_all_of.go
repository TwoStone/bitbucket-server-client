...
func (o BranchesPageAllOf) MarshalJSON() ([]byte, error) {
...
type NullableBranchesPageAllOf struct {
	value *BranchesPageAllOf
	isSet bool
}

func (v NullableBranchesPageAllOf) Get() *BranchesPageAllOf {
	return v.value
}

func (v *NullableBranchesPageAllOf) Set(val *BranchesPageAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableBranchesPageAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableBranchesPageAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBranchesPageAllOf(val *BranchesPageAllOf) *NullableBranchesPageAllOf {
	return &NullableBranchesPageAllOf{value: val, isSet: true}
}

func (v NullableBranchesPageAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBranchesPageAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
