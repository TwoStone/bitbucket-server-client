...
type BranchMetadataAheadBehind struct {
...
func NewBranchMetadataAheadBehind(ahead int32, behind int32) *BranchMetadataAheadBehind {
	this := BranchMetadataAheadBehind{}
	this.Ahead = ahead
	this.Behind = behind
	return &this
}
...
func (o BranchMetadataAheadBehind) MarshalJSON() ([]byte, error) {
...
type NullableBranchMetadataAheadBehind struct {
	value *BranchMetadataAheadBehind
	isSet bool
}

func (v NullableBranchMetadataAheadBehind) Get() *BranchMetadataAheadBehind {
	return v.value
}

func (v *NullableBranchMetadataAheadBehind) Set(val *BranchMetadataAheadBehind) {
	v.value = val
	v.isSet = true
}

func (v NullableBranchMetadataAheadBehind) IsSet() bool {
	return v.isSet
}

func (v *NullableBranchMetadataAheadBehind) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBranchMetadataAheadBehind(val *BranchMetadataAheadBehind) *NullableBranchMetadataAheadBehind {
	return &NullableBranchMetadataAheadBehind{value: val, isSet: true}
}

func (v NullableBranchMetadataAheadBehind) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBranchMetadataAheadBehind) UnmarshalJSON(src []byte) error {
	v.isSet = true
