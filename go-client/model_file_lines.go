...
func (o FileLines) MarshalJSON() ([]byte, error) {
...
type NullableFileLines struct {
	value *FileLines
	isSet bool
}

func (v NullableFileLines) Get() *FileLines {
	return v.value
}

func (v *NullableFileLines) Set(val *FileLines) {
	v.value = val
	v.isSet = true
}

func (v NullableFileLines) IsSet() bool {
	return v.isSet
}

func (v *NullableFileLines) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileLines(val *FileLines) *NullableFileLines {
	return &NullableFileLines{value: val, isSet: true}
}

func (v NullableFileLines) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileLines) UnmarshalJSON(src []byte) error {
	v.isSet = true
