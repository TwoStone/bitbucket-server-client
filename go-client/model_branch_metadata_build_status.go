...
type BranchMetadataBuildStatus struct {
...
func NewBranchMetadataBuildStatus(successful int32, inProgress int32, failed int32) *BranchMetadataBuildStatus {
	this := BranchMetadataBuildStatus{}
...
func (o BranchMetadataBuildStatus) MarshalJSON() ([]byte, error) {
...
type NullableBranchMetadataBuildStatus struct {
	value *BranchMetadataBuildStatus
	isSet bool
}

func (v NullableBranchMetadataBuildStatus) Get() *BranchMetadataBuildStatus {
	return v.value
}

func (v *NullableBranchMetadataBuildStatus) Set(val *BranchMetadataBuildStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableBranchMetadataBuildStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableBranchMetadataBuildStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBranchMetadataBuildStatus(val *BranchMetadataBuildStatus) *NullableBranchMetadataBuildStatus {
	return &NullableBranchMetadataBuildStatus{value: val, isSet: true}
}

func (v NullableBranchMetadataBuildStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBranchMetadataBuildStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
