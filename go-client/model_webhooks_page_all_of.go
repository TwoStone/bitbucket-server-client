...
func (o WebhooksPageAllOf) MarshalJSON() ([]byte, error) {
...
type NullableWebhooksPageAllOf struct {
	value *WebhooksPageAllOf
	isSet bool
}

func (v NullableWebhooksPageAllOf) Get() *WebhooksPageAllOf {
	return v.value
}

func (v *NullableWebhooksPageAllOf) Set(val *WebhooksPageAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhooksPageAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhooksPageAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhooksPageAllOf(val *WebhooksPageAllOf) *NullableWebhooksPageAllOf {
	return &NullableWebhooksPageAllOf{value: val, isSet: true}
}

func (v NullableWebhooksPageAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhooksPageAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
