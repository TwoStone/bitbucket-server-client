...
type BranchMetadataJiraIssue struct {
	Key string `json:"key"`
	Url string `json:"url"`
}
...
func (o BranchMetadataJiraIssue) MarshalJSON() ([]byte, error) {
...
type NullableBranchMetadataJiraIssue struct {
	value *BranchMetadataJiraIssue
	isSet bool
}

func (v NullableBranchMetadataJiraIssue) Get() *BranchMetadataJiraIssue {
	return v.value
}

func (v *NullableBranchMetadataJiraIssue) Set(val *BranchMetadataJiraIssue) {
	v.value = val
	v.isSet = true
}

func (v NullableBranchMetadataJiraIssue) IsSet() bool {
	return v.isSet
}

func (v *NullableBranchMetadataJiraIssue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBranchMetadataJiraIssue(val *BranchMetadataJiraIssue) *NullableBranchMetadataJiraIssue {
	return &NullableBranchMetadataJiraIssue{value: val, isSet: true}
}

func (v NullableBranchMetadataJiraIssue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBranchMetadataJiraIssue) UnmarshalJSON(src []byte) error {
	v.isSet = true
