...
func (o ProjectsPageAllOf) MarshalJSON() ([]byte, error) {
...
type NullableProjectsPageAllOf struct {
	value *ProjectsPageAllOf
	isSet bool
}

func (v NullableProjectsPageAllOf) Get() *ProjectsPageAllOf {
	return v.value
}

func (v *NullableProjectsPageAllOf) Set(val *ProjectsPageAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectsPageAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectsPageAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectsPageAllOf(val *ProjectsPageAllOf) *NullableProjectsPageAllOf {
	return &NullableProjectsPageAllOf{value: val, isSet: true}
}

func (v NullableProjectsPageAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectsPageAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
