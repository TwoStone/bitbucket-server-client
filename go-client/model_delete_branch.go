...
func (o DeleteBranch) MarshalJSON() ([]byte, error) {
...
type NullableDeleteBranch struct {
	value *DeleteBranch
	isSet bool
}

func (v NullableDeleteBranch) Get() *DeleteBranch {
	return v.value
}

func (v *NullableDeleteBranch) Set(val *DeleteBranch) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteBranch) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteBranch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteBranch(val *DeleteBranch) *NullableDeleteBranch {
	return &NullableDeleteBranch{value: val, isSet: true}
}

func (v NullableDeleteBranch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteBranch) UnmarshalJSON(src []byte) error {
	v.isSet = true
